...
-- 2. Show the name for the countries that have a population of at least 200 million. 200 million
...
-- 13. Find the country that has all the vowels and no spaces in its name. Those with more than one word in the name do not count
SELECT name
FROM world
WHERE name LIKE '%a%'
  AND name LIKE '%e%'
